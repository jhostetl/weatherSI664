from weather.models import TempsHourly, Cities
from api.serializers import TempsHourlySerializer
...
class SiteViewSet(viewsets.ModelViewSet):
	...
	"""
	queryset = TempsHourly.objects.select_related('city').order_by('time_period')
	serializer_class = TempsHourlySerializer
